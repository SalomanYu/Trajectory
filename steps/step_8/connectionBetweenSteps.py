...
from settings.config import CURRENT_MONTH, ConnectionBetweenSteps, ResumeGroup


def connect_to_db():
    folder = f"Data/SQL/{CURRENT_MONTH}"
...
def find_connection_between_steps(resumes: list[ResumeGroup]) -> set[ConnectionBetweenSteps]:
